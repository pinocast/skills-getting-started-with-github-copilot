...
activities = {
    ...
    "Basketball Club": {
        "description": "Pick-up games and drills to improve basketball skills",
        "schedule": "Wednesdays and Fridays, 5:00 PM - 7:00 PM",
        "max_participants": 15,
        "participants": ["sophia2@mergington.edu", "mason@mergington.edu"]
    },
    "Drama Club": {
    ...
    "Robotics Club": {
        ...
        "max_participants": 12,
        "participants": ["grace@mergington.edu", "sofia@mergington.edu"]
    }
}
activities = {
    "Chess Club": {
